...
$(EXEC) : $(OBJDIR)/principale.o $(OBJDIR)/projection.o $(OBJDIR)/pendule.o
	$(CC) -g  $(OBJDIR)/principale.o $(OBJDIR)/projection.o $(OBJDIR)/pendule.o ` sdl2-config --libs` $(LDFLAGS) -o $(EXEC)
